...
public class ModdedZombieModel<T extends HostileEntity> extends AbstractZombieModel<T> {
    protected ModdedZombieModel(ModelPart modelPart) {
        super(modelPart);
    }

    public boolean isAttacking(HostileEntity entity) {
        return false;
    }
